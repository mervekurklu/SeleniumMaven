...
public class G02_Task extends BaseTest {
    /*
    1. "https://facebook.com" adresine gidin.--mülakat
...
*/
    ...
    public void facebook(){
        ...
        actions.click(firstName)
                .sendKeys(faker.name().firstName()+Keys.TAB)//böyle de yazılabilir..
                .sendKeys(faker.name().lastName()).sendKeys(Keys.TAB)
                .sendKeys(email).sendKeys(Keys.TAB)
                .sendKeys(email).sendKeys(Keys.TAB)
                .sendKeys(faker.internet().password()+Keys.TAB+Keys.TAB)//burayı da değiştirdim..
                ...
                .sendKeys(Keys.ARROW_RIGHT).sendKeys(Keys.ARROW_LEFT).sendKeys(Keys.TAB).sendKeys(Keys.TAB).sendKeys(Keys.TAB).sendKeys(Keys.TAB).sendKeys(Keys.TAB).sendKeys(Keys.ENTER).perform();
