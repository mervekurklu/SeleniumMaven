...
public class G03_Task extends BaseTest {
    /*
 ...
 */
    ...
    public void acceptAlert(){
        ...
        Assert.assertEquals("You successfully clicked an alert",driver.findElement(By.id("result")).getText());//burada yer değiştirdim!
    }
